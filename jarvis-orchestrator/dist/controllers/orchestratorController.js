...
exports.orchestratorController = exports.OrchestratorController = void 0;
...
class OrchestratorController {
    constructor() {
        this.orchestrate = async (req, res) => {
            ...
            try {
                ...
                const agentResults = await this.agentCommunicator.processWithAgents(routingDecision.selectedAgents, orchestrationRequest, requestId);
                const response = {
                    requestId,
                    status: 'success',
        ...
        this.taskRouter = new taskRouter_1.TaskRouter();
        this.agentCommunicator = new agentCommunicator_1.AgentCommunicator();
    }
}
exports.OrchestratorController = OrchestratorController;
exports.orchestratorController = new OrchestratorController();
